...
public class TruckEventProcessingTopology extends BaseTruckEventTopology 
{
    ...
    public void configureHDFSBolt(TopologyBuilder builder) 
    {
        ...
        System.out.println("Created hivePartitionAction with " + sourceMetastoreUrl + " " + hiveStagingTableName + " " + databaseName + " " + fsUrl + " " + String.valueOf(rotationTimeInMinutes)) ;
       ...
       System.out.println("Created  hdfsBolt with hivePartitionAction");                
       ...
       System.out.println("Created shufflegrouping from Kafka spout to HDFS bolt");                
